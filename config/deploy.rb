...
if ENV['DATABASE_URL'].blank?
  ...
  after :'docker:export_env', 'docker:destroy'
  after :'docker:destroy', 'docker:remove_networks'
  after :'docker:remove_networks', 'docker:create_volums'
  after :'docker:create_volums', 'docker:build'
  after :'docker:build', 'docker:up'
